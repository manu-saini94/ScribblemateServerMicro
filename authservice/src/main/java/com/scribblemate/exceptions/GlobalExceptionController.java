...
public class GlobalExceptionController {
    ...
    public ResponseEntity<ErrorResponse> handleUserNotUpdatedException(UserNotUpdatedException exp) {
        return buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, ResponseErrorUtils.ERROR_PERSISTING_USER,
                exp.getMessage());
    }

    @ExceptionHandler(value = UsersFetchException.class)
    public ResponseEntity<ErrorResponse> handleUsersFetchException(UsersFetchException exp) {
        return buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, ResponseErrorUtils.FETCH_ALL_USERS_ERROR,
                exp.getMessage());
    }
