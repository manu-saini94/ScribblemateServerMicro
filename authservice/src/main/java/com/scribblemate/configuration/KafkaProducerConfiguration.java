...
public class KafkaProducerConfiguration {
    ...
    @Bean
    ProducerFactory<Long, UserEventData> producerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfigs());
    }

    @Bean
    KafkaTemplate<Long, UserEventData> kafkaTemplate() {
        return new KafkaTemplate<>(producerFactory());
    }

    @Bean
    NewTopic createTopicUserCreated() {
    ...
    @Bean
    NewTopic createTopicUserUpdated() {
    ...
    @Bean
    NewTopic createTopicUserDeleted() {
